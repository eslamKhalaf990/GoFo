//Islam kalaf => 20190096
//Ahmed Osama => 20190015
//Omar Hany   => 20190364
...
public class Terminal {
    ...
    public void cd(String MyDirectory) {
        if (MyDirectory.equals(""))
            ...
            if (MyDirectory.equals("..")) {
                ...
                String parent_folder =current_directory.getParent()+"\\";
                System.setProperty( "user.dir",parent_folder);
            }

            else {
                File myNewFile=new File(MyDirectory);
                if(!myNewFile.exists()) {
                    myNewFile=new File(System.getProperty("user.dir")+MyDirectory);
                }
                if (myNewFile.isDirectory()) {
                    String new_directory = myNewFile.toString()+"\\";
                    System.setProperty("user.dir", new_directory);
                }
                else {
                    System.out.println("Error : " + MyDirectory+ " is not a directory ");
                }
            }
        }
    }
